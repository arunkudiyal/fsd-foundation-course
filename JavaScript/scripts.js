...
// 1. var keyword is GLOBAL in nature - PUBLIC
// 2. let(ES6) keyword is used for scoping - LOCAL
// 3. const(ES6) keyword - LOCAL
...
const myName = 'Arun'
// const myConstValue --> SHOULD NOT DO
// myName = 100
...
// console.log('My lucky number is ' + myLuvkyNumber + ', this is an example');
...
// console.log(employees[0].skiils[1])
...
// let productResult = product(10, 20)
...
// let functionName/variableName = (parameter(s)) => { ...bodyOfTheFUnction }
// let newProduct = (a, b) => {
//     if(typeof a == 'number' && typeof b == 'number') {
//         return a * b
//     } else {
...
// let newProductResult = newProduct(100, 200)
